...
public class FansRoomAdapter extends ArrayAdapter<FansRoom> {
    ...
    public void update() {
        ...
        fansRoomsList.add(new FansRoom("1", "1", "Fans Room 1", 12, "brasil"));
        fansRoomsList.add(new FansRoom("5", "1", "Fans Room 2", 134, "brasil"));
        fansRoomsList.add(new FansRoom("3", "1", "Fans Room 3", 54, "brasil"));
        fansRoomsList.add(new FansRoom("7", "1", "Fans Room 4", 95, "brasil"));
        fansRoomsList.add(new FansRoom("2", "2", "Fans Room 1", 10, "brasil"));
        fansRoomsList.add(new FansRoom("4", "2", "Fans Room 2", 33, "brasil"));
        fansRoomsList.add(new FansRoom("6", "2", "Fans Room 3", 4, "brasil"));
        fansRoomsList.add(new FansRoom("8", "2", "Fans Room 4", 2, "brasil"));
